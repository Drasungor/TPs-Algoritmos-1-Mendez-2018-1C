...
char obtener_casa() {
  ...
  bool pertenece_a_gryffindor = false;
  bool pertenece_a_ravenclaw = false;
  bool pertenece_a_slytherin = false;
  char casa='a';
  ...
  pertenece_a_gryffindor = es_gryffindor(fuerza, valor, ingenio, inteligencia, dedicacion);
  pertenece_a_ravenclaw = es_ravenclaw(fuerza, valor, ingenio, inteligencia, dedicacion);
  pertenece_a_slytherin = es_slytherin(fuerza, valor, ingenio, inteligencia, dedicacion);
